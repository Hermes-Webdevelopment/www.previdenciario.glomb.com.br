...
const AposentadoriaTempoEspecial: NextPage = () => {
  ...
  const linkWhatsAp = 'https://wa.me/554132239132?text=Olá!+Gostaria+de+analisar+meu+caso+sem+compromisso+-+aposentadoria+rural'
...
return (
  <>
    <Head>
      ...
      <meta name="keywords" content="aponsentadoria rural; aposentadoria hibrida; aposentadoria trabalhador rural; "></meta>
